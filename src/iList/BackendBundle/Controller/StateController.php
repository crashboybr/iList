...
use iList\BackendBundle\Entity\State;
use iList\BackendBundle\Form\StateType;
...
class StateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('iListBackendBundle:State')->findAll();

        return $this->render('iListBackendBundle:State:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('iListBackendBundle:State:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('iListBackendBundle:State')->find($id);
        ...
        return $this->render('iListBackendBundle:State:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('iListBackendBundle:State:edit.html.twig', array(
            'entity'      => $entity,
